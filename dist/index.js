...
var InstagramInteractionService = class {
  ...
  async generateResponse(text, username, action) {
    ...
    const state = await this.runtime.composeState(
      ...
      {
        instagramUsername: (_a = this.state.profile) == null ? void 0 : _a.username,
    ...
    try {
      const state = await this.runtime.composeState(
        ...
        },
        {
          ...
          username: (_b = item.user) == null ? void 0 : _b.username,
          content: item.text || ""
        }
      );
      ...
      if (decision.includes("[INTERACT]")) {
        ...
        if (userFeed.length > 0) {
          ...
          elizaLogger4.log(`Liked post from user: ${(_c = item.user) == null ? void 0 : _c.username}`);
        }
      }
    } catch (error) {
  ...
  async generateNewPost() {
    ...
    try {
      ...
      const roomId2 = stringToUuid2(
        "instagram_generate_room-" + ((_a = this.state.profile) == null ? void 0 : _a.username)
      );
      await this.runtime.ensureUserExists(
        this.runtime.agentId,
        ((_b = this.state.profile) == null ? void 0 : _b.username) || "",
      ...
      const state = await this.runtime.composeState(
        ...
        {
          instagramUsername: (_c = this.state.profile) == null ? void 0 : _c.username
        }
      );
  ...
  async getOrGenerateImage(content) {
    try {
      ...
      const result = await generateImage(
        {
          prompt: content,
          width: (imageSettings == null ? void 0 : imageSettings.width) || 1024,
          height: (imageSettings == null ? void 0 : imageSettings.height) || 1024,
          count: (imageSettings == null ? void 0 : imageSettings.count) || 1,
          negativePrompt: (imageSettings == null ? void 0 : imageSettings.negativePrompt) || null,
          numIterations: (imageSettings == null ? void 0 : imageSettings.numIterations) || 50,
          guidanceScale: (imageSettings == null ? void 0 : imageSettings.guidanceScale) || 7.5,
          seed: (imageSettings == null ? void 0 : imageSettings.seed) || null,
          modelId: (imageSettings == null ? void 0 : imageSettings.modelId) || null,
          jobId: (imageSettings == null ? void 0 : imageSettings.jobId) || null,
          stylePreset: (imageSettings == null ? void 0 : imageSettings.stylePreset) || "",
          hideWatermark: (imageSettings == null ? void 0 : imageSettings.hideWatermark) ?? true,
          safeMode: (imageSettings == null ? void 0 : imageSettings.safeMode) ?? true,
          cfgScale: (imageSettings == null ? void 0 : imageSettings.cfgScale) || null
        },
        this.runtime
      );
...
var index_default = instagramPlugin;
export {
